...
public class ProdutoController {
    ...
    public ModelAndView getProdutosList() throws Exception {
        ProdutoService s = new ProdutoService();
        List<Produto> produtoList = s.readByCriteria(null);
    ...
    public ModelAndView postProdutoForm(@PathVariable Long id, String nome, Double preco, Long categoria) throws Exception {
